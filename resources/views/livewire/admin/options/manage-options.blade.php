<div>
        ...
        <div class="p-6">
            <div class="space-y-6">
                @foreach ($options as $option)
                    <div class="p-6 rounded-lg border border-gray-300 relative" wire:key="option-{{ $option->id }}">

                        <div class="absolute -top-3 px-4 bg-white">
                            <button class="mr-1" onclick="confirmedDelete({{$option->id}}, 'option')">
                                ...
                                @switch($option->type)
                                    @case(1)
                                        ...
                                        <span
                                            ...
                                            <button class="ml-0.5" 
                                                onclick="confirmedDelete({{ $feature->id }}, 'feature')">
        ...
        <x-slot name="content">
            ...
            <div class="mb-4 space-y-4">
                @foreach ($newOption->features as $index => $feature)
                    <div class="p-6 rounded-lg border border-gray-300 relative" wire:key="features-{{ $index }}">
    ...
    @push('js')
        <script>
            function confirmedDelete(id, type) {
                Swal.fire({
                    title: "¿Estás seguro?",
